...
<div class="col-7 myaccount-form ">
		...
		<h2 class="active">My Details</h2>
			...
			<div class="row brand-block-tab">
				...
				<div class="col-4 input-adjust">
					...
					<div class="form-row ">
	              		<button class="button button-tertiary update_password progress-button" id="update_password" name="save_account_details" data-style="shrink" data-horizontal id="check_password"><span class="content"> Save</span><span class="progress"><span class="progress-inner"></span></span></button>
    ...
    <div class="form-row remove-space">
          <button class="button button-tertiary progress-button" id="newsletter" data-style="shrink" data-horizontal><span class="content"> Save</span><span class="progress"><span class="progress-inner"></span></span></button>
...
<div class="myaccount-subform active" id="address">
  <div class="accord active">Add Address</div>
...
if (isset($_POST['save']) && $_POST['save'] !=''){	
	...
	foreach ($existing_addresses as $key => $value) {
		...
		//  		echo 	$value['phone_number'].'<br>';	
		//   		echo 	$value['city'].'<br>';	
		//    		echo 	$value['landmark'].'<br>';	
		//     		echo 	$value['state'].'<br>';	
		//      		echo 	$value['address'].'<br>';	
		//      		echo 	$value['postcode'].'<br>';	
		  ...
		  $value['city']== $city &&
		   $value['county']== $county &&
		     ...
		     $value['country']== $country ){
						...
						if($_GET['from']=='chckpage')
						{
				echo "<script type=\"text/javascript\">";
		       	echo "window.location='" . get_bloginfo('url') . "/checkout?editedlast=".$key."'";
		        echo "</script>";
				exit;
						}else{
			echo "<script type=\"text/javascript\">";
...
?>
               <form action="" class="addaddress_form" method="post">
    <div class="form-wrap">

    
      <div class="form-row form-row" id="billing_first_name_field"><label for="billing_first_name" class="floating-item" data-error="Please enter your first name"></label><div class="floating-item" data-error="Please enter your first name"><input type="text" class="input-text floating-item-input input-item input-email-active" name="firstname" id="billing_first_name" placeholder="" value="<?php echo $_POST['firstname'];?>" maxlength="75" onkeypress="return apostrophe(event, this)"><span class="floating-item-label" >FIRST NAME</span></div></div>
    
      <div class="form-row form-row floating-item " id="billing_last_name_field"><label for="billing_last_name" class="floating-item" data-error="Please enter your last name"></label><div class="floating-item" data-error="Please enter your last name"><input type="text" class="input-text floating-item-input input-item validate input-email-active" name="lastname" id="billing_last_name" placeholder="" value="<?php echo $_POST['lastname'];?>" maxlength="75" onkeypress="return apostrophe(event, this)"><span class="floating-item-label" >LAST NAME</span></div></div><div class="clear"></div>
    
      <div class="form-row floating-item address-field " id="billing_address_1_field"><div class="floating-item" data-error="Please enter the your address line one"><input type="text" class="input-text floating-item-input input-item validate input-email-active" name="address1" id="billing_address_1" placeholder="" value="<?php echo $_POST['address1'];?>" onkeypress="return apostrophespecial(event, this)"><label for="billing_address_1" class="floating-item-label floating-item"  data-error="Please enter the your address line one">ADDRESS LINE 1</label></div></div>
      ...
      <div class="form-row form-row floating-item address-field " id="billing_city_field"><div class="floating-item" data-error="Please enter the name of the city you live in"><input type="text" class="input-text floating-item-input input-item validate input-email-active" name="city" id="billing_city" placeholder="" value="<?php echo $_POST['city'];?>" onkeypress="return apostrophespecial(event, this)"><label for="billing_city" class="floating-item-label floating-item"  data-error="Please enter the name of the city you live in">City</label><span class="floating-item-label">City</span></div></div>
    
      <div class="form-row form-row floating-item validate address-field " id="billing_postcode_field"><div class="floating-item" data-error="Please enter your postcode"><input type="text" class="input-text floating-item-input input-item validate input-email-active" name="postcode" id="billing_postcode" placeholder="" value="<?php echo $_POST['postcode'];?>" onkeypress="return isNumber(event)"><label for="billing_postcode" class="floating-item-label floating-item"  data-error="Please enter your postcode">Postcode</label><span class="floating-item-label">Postcode</span></div></div>
              ...
              <div class="form-row select-row">
               ...
               <?php
                foreach ($countyArray as $countykey => $value) { ?>
                          ...
                          <option value="<?php echo $value;?>"<?php if($_POST['county']==$value){ echo "selected";} ?> ><?php echo $value;?></option>
                <?php }?>
