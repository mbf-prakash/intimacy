	...
	*/
    ...
    function generate_payu_in_form($order_id) {
		...
		return '<form action="' . $posturl . '" method="POST" name="payform" id="payform">
				' . $payuform . '
				<input type="submit" class="button" id="submit_payu_in_payment_form" value="' . __( 'Confirm order', 'woocommerce_payu_in' ) . '" /> <a class="button cancel" href="' . $order->get_cancel_order_url() . '">'.__( 'Cancel order', 'woocommerce_payu_in' ) . '</a>
